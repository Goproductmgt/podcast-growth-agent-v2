// ============================================================================
// TEST: Pulse Agent Only
// Tests the Pulse agent independently before orchestrator
// ============================================================================

import 'dotenv/config';
import { readFileSync, readdirSync } from 'fs';
import { join } from 'path';
import { runPulseAgent } from './api/agents/pulse';
...
async function testPulseAgent() {
  ...
  try {
    ...
    const result = await runPulseAgent(transcript);
    
    const totalTime = Date.now() - startTime;
    
    // Display results
    if (result.success) {
      console.log('✅ PULSE AGENT SUCCESS!\n');
      ...
      console.log('❌ PULSE AGENT FAILED!\n');
